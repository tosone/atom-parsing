      ...
      if (topic === 'interaction/script/keysbind') {
        ...
        try {
          ...
          if (btns.length === 0) {
            ...
            this.evt && this.evt.emit('btn', { btns, btn })
            this.btn(btn);
          }
        }
        ...
        try {
          ...
          if (keywords.length === 0) {
            ...
            this.evt && this.evt.emit('keyword', { keyword, keywords });
            this.reply(keyword);
          }
        }
...
let test = new Test();
module.exports = test.setEvt.bind(test);
